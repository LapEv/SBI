...
export const IncidentData = () => {
  ...
  const [selectedContract, setSelectedContract] = useState<Options>(emptyValue)
  ...
  return (
    <Box
      sx={{ ...modalStyle, width: '80%', minHeight: 500, position: 'relative' }}
      component="form"
      ...
      <ButtonsModalSection
        ...
        closeModal={() => console.log('close incident data')}
        btnName="Сохранить"
      />
    </Box>
  )
